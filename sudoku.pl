...
solve([V0_0, V0_1, V0_2, V0_3, V0_4, V0_5, V0_6, V0_7, V0_8, V1_0, V1_1, V1_2, V1_3, V1_4, V1_5, V1_6, V1_7, V1_8, V2_0, V2_1, V2_2, V2_3, V2_4, V2_5, V2_6, V2_7, V2_8, V3_0, V3_1, V3_2, V3_3, V3_4, V3_5, V3_6, V3_7, V3_8, V4_0, V4_1, V4_2, V4_3, V4_4, V4_5, V4_6, V4_7, V4_8, V5_0, V5_1, V5_2, V5_3, V5_4, V5_5, V5_6, V5_7, V5_8, V6_0, V6_1, V6_2, V6_3, V6_4, V6_5, V6_6, V6_7, V6_8, V7_0, V7_1, V7_2, V7_3, V7_4, V7_5, V7_6, V7_7, V7_8, V8_0, V8_1, V8_2, V8_3, V8_4, V8_5, V8_6, V8_7, V8_8]) :-    V0_0 in 1..9,V0_1 in 1..9,V0_2 in 1..9,V0_3 in 1..9,V0_4 in 1..9,V0_5 in 1..9,
   ...
   V0_0 #= 5,V0_1 #= 3,V0_4 #= 7,V1_0 #= 6,V1_3 #= 1,V1_4 #= 9,V1_5 #= 5,V2_1 #= 9,
   V2_2 #= 8,V2_7 #= 6,V3_0 #= 8,V3_4 #= 6,V3_8 #= 3,V4_0 #= 4,V4_3 #= 8,V4_5 #= 3,
   V4_8 #= 1,V5_0 #= 7,V5_4 #= 2,V5_8 #= 6,V6_1 #= 6,V6_6 #= 2,V6_7 #= 8,V7_3 #= 4,
   V7_4 #= 1,V7_5 #= 9,V7_8 #= 5,V8_4 #= 8,V8_7 #= 7,V8_8 #= 9,
